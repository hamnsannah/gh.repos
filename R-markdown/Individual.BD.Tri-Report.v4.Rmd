...
bars <- nb.horiz.bars.owner(yy.matched, recip.counter[1,1], period.names.vec[1])
...
bars <- nb.horiz.bars.owner(yy.matched, recip.counter[1,1], period.names.vec[2])
...
bars <- nb.horiz.bars.owner(yy.matched, recip.counter[1,1], period.names.vec[3])
