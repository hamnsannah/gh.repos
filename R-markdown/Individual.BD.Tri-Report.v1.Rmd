...
Charts show Month To Date, Quarter To Date, and Year To Date data for 1 BD/CRD
...
new.mtd.fix <- mtd.prep(new.mtd, class.data, "2016-01-01", "2017-06-30")
...
bars <- nb.horiz.bars.owner(yy.matched, "R. Kaufman", period.names.vec[1])
...
bars <- nb.horiz.bars.owner(yy.matched, "R. Kaufman", period.names.vec[2])
...
bars <- nb.horiz.bars.owner(yy.matched, "R. Kaufman", period.names.vec[3])
